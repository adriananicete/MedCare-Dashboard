...
function LabResults() {
  ...
  return (
    <div className="bg-[#fff] w-full h-[auto] rounded-[16px] shadow-md p-[20px] flex flex-col justify-center items-start gap-8">
        <h2 className="text-[24px] font-[600]  ">Lab Result</h2>
        <div className="flex flex-col w-full h-[150px] justify-start items-center gap-8 overflow-y-scroll">
